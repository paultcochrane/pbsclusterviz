...
def usage():
    print """Usage:
    python cluster_status.py -t/--three_d_view
    """
...
for host in host_list:
    ...
    if host.is_down():
        print "Host marked as down:", hostname
...
if interactive:
    ...
    if three_d_view:
        out_writer.SetFileName("cluster_status.png")
    else:
        out_writer.SetFileName("cluster_status_2d.png")
    ...
    if three_d_view:
        fname_str = "cluster_status_%s.png" % (date_str)
    else:
        fname_str = "cluster_status_2d_%s.png" % (date_str)
